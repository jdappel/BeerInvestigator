...
@Singleton
@Component(modules = [ViewModelModule::class, BreweryDBServiceModule::class, AndroidInjectionModule::class, ActivityModule::class, BeerModule::class, RepoModule::class, UtilsModule::class])
